...
#include "robot_msgs/msg/detail/nav_debug__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robot_msgs::msg::NavDebug & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_msgs::msg::NavDebug & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_msgs::msg::NavDebug;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_msgs::msg::NavDebug *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_msgs::msg::NavDebug *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _NavDebug__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const robot_msgs::msg::NavDebug *>(
...
static size_t _NavDebug__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_NavDebug(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _NavDebug__callbacks = {
  "robot_msgs::msg",
  "NavDebug",
...
static rosidl_message_type_support_t _NavDebug__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_NavDebug__callbacks,
...
{
  return &robot_msgs::msg::typesupport_fastrtps_cpp::_NavDebug__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_msgs, msg, NavDebug)() {
  return &robot_msgs::msg::typesupport_fastrtps_cpp::_NavDebug__handle;
}
